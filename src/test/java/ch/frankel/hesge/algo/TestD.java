...
public class TestD {
    ...
    public Object[][] data() {
        ...
        data[0] = new Object[]{
                Collections.singletonList(restaurant1),
                mappings1
        };
        ...
        data[1] = new Object[]{
                Arrays.asList(restaurant2, restaurant3),
                mappings2
        };
    ...
    public void shouldReturnExpectedMap(Collection<Restaurant> input, Map<Restaurant, Collection<Chef>> expected) {
        Map<Restaurant, Collection<Chef>> result = d.apply(input);
